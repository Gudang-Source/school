                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control" name="mapel">
                        ...
                        <option value="<?php echo $m["id_mapel"] ?>"><?php echo $m["mapel"]?></option>
                        <?php endforeach ?>
                      </select>
                    </div>
                  </div>
            ...
            <div class="row">
              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <a href="<?php echo  base_url('c_add/lanjut') ?>"><button class="btn btn-inverse-success btn-rounded" type="button">Lanjut</button></a>
                </div>
