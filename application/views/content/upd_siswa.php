                                    ...
                                    <form class="forms-sample" action="<?php echo site_url('c_siswa/add_siswact') ?>" method="POST">
                                        <?php foreach ($siswa->result() as $s) { ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="nama" id="exampleInputName1" placeholder="Nama" value="<?= $s->nama ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" name="nis" id="exampleInputEmail3" placeholder="NIS" value="<?= $s->nis ?>">
                                                <div class="text-danger">
                                                    <?= form_error('nis') ?>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputEmail3" name="hp" placeholder="Nomer Handphone" value="<?= $s->nope ?>">
